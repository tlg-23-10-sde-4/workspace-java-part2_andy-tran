...
//        List<Employee> res = allEmployees.stream()
//                .filter(emp -> emp.getHireDate().getYear() && emp.getSalary() < 50000.0)
//                .sorted(comparing(Employee::getSalary))
...
//    }
    ...
    public void allEmployeesHired2000_orLater() {
        boolean hm = allEmployees.stream()
                .allMatch(emp -> emp.getHireDate().getYear() >= 200);
    ...
    public void averageSalary_hired2000_orLater() {
        double avg = allEmployees.stream()
    ...
    public void groupingByYearOfHire() {
        Map<Integer,List<Employee>> m = allEmployees.stream()
